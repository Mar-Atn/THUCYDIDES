...
**Classification: FACILITATOR ONLY — Do not distribute to participants. Individual role slices are generated from this master document.**

---

## Purpose

This document maps the **key relationships** for every role in the SIM. Each role gets 3-6 relationships — only the most game-driving ones. Participants cannot hold more than that in working memory.

**How to use:** Slice by role to extract the relationship section for each role's brief. Each relationship is written from THAT role's perspective — asymmetric by design (Dealer's view of Helmsman differs from Helmsman's view of Dealer).

**Visual version:** `SEED_B3_RELATIONSHIPS_v1.html` — interactive graph with all 37 roles and ~80 edges.

**Source of truth for role names:** B2 Role Seed files (`B2_ROLES/SEED_B2_ROLES_*.md`)

---

## COLUMBIA TEAM (7 roles)
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** | INTERNAL | Your patron. You're the chosen heir — loyal but building your own identity. You need his endorsement desperately. He keeps you guessing. |
| **Anchor** | TENSION | Direct competition for the presidential nomination. You're closer to Dealer ideologically. Anchor has international credibility and a Congressional base. This is the race of your life. |

### ANCHOR — Secretary of State

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** | INTERNAL | You're his succession rival. You drive Persia and Caribe policy harder than he does. Establishment hawk vs. transactional dealmaker. |
| **Volt** | TENSION | You're both running. You have international credibility; Volt has Dealer's ear. |
| **Havana** (Caribe) | HOSTILE | Monroe Doctrine enforcer. Strategic AND personal. Maduro captured. Regime change on your agenda. |
| **Sage** (Cathay) | CHANNEL | Foreign ministry back-channel. You can explore deals leaders can't discuss publicly. Six rounds of talks already held. |

### SHIELD — Secretary of Defense

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** | INTERNAL | You co-sign military orders. Professional warrior-philosopher. You respect him but worry about overextension. You can slow him. |
| **Rampart** (Cathay) | HOSTILE | Pacific arms race. Columbia 11 ships vs. Cathay 7 (+1/round). Crossover at R3-4. This is the military dimension of the Trap. |
| **Anvil** (Persia) | HOSTILE | Gulf Gate blockade — you're planning the military response. Ground forces needed to break it. |
| **Sakura** (Yamato) | ALLIANCE | Your most capable Pacific partner. Joint exercises, base hosting, intelligence sharing. Yamato is remilitarizing at historic pace. |
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** | HOSTILE | Constitutional war. Executive vs. legislature. War authorization is your weapon. The domestic confrontation is more visceral than most foreign rivalries. |

### CHALLENGER — Opposition Presidential Candidate

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** | TENSION | Populist mirror of the president. You offer foreign leaders an alternative future. Anti-establishment, unpredictable — you can promise what Dealer can't deliver. |
...
| **Abacus** | INTERNAL | Your Premier is quietly gaining economic autonomy. Pro-business, reassuring entrepreneurs after your crackdown. He operates within your parameters — but he has real room. |

### RAMPART — PLA Marshal

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Helmsman** | TENSION | You're a purge survivor. 36 generals removed before you. You're untested — loyal by appointment, not by trust. The CMC is hollowed out around you. |
| **Shield** (Columbia) | HOSTILE | Pacific arms race. Naval buildup, Formosa contingency. Columbia's military is your benchmark. |

### ABACUS — Premier (Economy)
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Helmsman** | INTERNAL | You execute semiconductor self-sufficiency. Tech summit with Jack Ma, Huawei, BYD, DeepSeek. Helmsman NEEDS your sector's cooperation after the crackdown. |

### SAGE — Party Elder

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Helmsman** | TENSION | You embody collective leadership tradition. He's centralized everything. Your quiet influence is a constraint he tolerates but resents. |
| **Anchor** (Columbia) | CHANNEL | You can explore deals leaders can't discuss publicly. Calibrated for Dealer's transactional style. Six rounds of talks already held. |
...
### IRONHAND — Chief of General Staff
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Pathfinder** | TENSION | Guns eating butter. Oil revenue down 34%. Budget cut 10% — all from the civilian side. Real inflation 20%+. You manage the impossible while military devours everything. |
| **Abacus** (Cathay) | DEPENDENCY | Your economy depends on Cathay as buyer, tech supplier, financial channel. They set the terms. Growing asymmetry you cannot reverse. |
| **Fixer** (Columbia) | CHANNEL | Miami back-channel. Weeks of secret talks produced the 28-point plan. Excluded everyone — even some Columbia officials. |
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Beacon** | HOSTILE | He fired you fearing your popularity. The army loves you. You're running for president. If you win, you take command back. If he delays the election, your momentum fades. |
| **Broker** | INTERNAL | Anti-Beacon coalition? You want military victory; he wants negotiated peace. Opposite policies but shared enemy. Coalition possible but fragile. |
...
### FURNACE — Supreme Leader

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Anvil** | TENSION | He installed you on the throne. You're starting to issue edicts without consulting him. Pull too hard — he breaks your legitimacy. Let you run — you become a threat. The most delicate power dynamic in the SIM. |
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Furnace** | TENSION | Kingmaker vs. King. You installed him. He's starting to believe the title gives real authority. You can't pull too hard without breaking the system. |
| **Dawn** | TENSION | You keep Dawn alive as controlled opposition. Safety valve — if the street erupts, only Dawn can channel it. Neither elimination nor empowerment. |
| **Shield** (Columbia) | HOSTILE | Gulf Gate blockade is YOUR main leverage. Wasting asset: 4-5 rounds max sustainability. Shield is planning the military response. |
| **Helmsman** (Cathay) | DEPENDENCY | 48% of your oil goes to Cathay. Without their channels, your economy collapses. They can squeeze or sustain you at will. |

### DAWN — Reformist President

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Furnace** | TENSION | Revolution vs. people. You represent 70M wanting normal life. You have no power — but you have legitimacy of the street. |
| **Anvil** | TENSION | He keeps you alive as a safety valve. You survive because you're useful. If the street erupts, only you can channel it — that's your leverage. |
| **Fixer** (Columbia) | CHANNEL | If the regime cracks, you're who the West talks to. This is the peace pathway. Anvil knows this — it's partly why he keeps you alive. |

---

## EUROPE TEAM (6 roles)

### LUMIERE — President of Gallia
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** (Columbia) | ALLIANCE | His favorite European. Only EU leader invited to inauguration. Shared ideology + personal chemistry. You're the US-EU bridge — trusted where others are despised. |
| **Forge** (Teutonia) | TENSION | You block EU spending and migration consensus. Forge needs EU unity — you're the constant obstacle on fiscal integration. |
| **Pillar** (EU) | TENSION | You challenge EU Commission authority. Sovereignty vs. institution. Pillar represents the unity you disrupt. |

### MARINER — PM of Albion
...
### WELLSPRING — Crown Prince of Solaria
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** (Columbia) | ALLIANCE | Wartime partners — Operation Epic Fury. You have direct access to Dealer. Shared intelligence, coordinated strikes. The tightest military partnership in the SIM. |
| **Furnace** (Persia) | HOSTILE | Multi-front war. Your intelligence knows how much of Persia's nuclear program survived. Direct strikes ongoing. |

### CHIP — President of Formosa
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Helmsman** (Cathay) | HOSTILE | You declared Formosa contingency "existential." Cathay retaliated with rare earth restrictions. You're remilitarizing at the fastest pace since 1945. |
| **Dealer** (Columbia) | TENSION | Cornerstone Pacific alliance — but Columbia is signaling contraction. You're remilitarizing because you no longer fully trust the protection. Anxiety, not warmth. |
| **Shield** (Columbia) | ALLIANCE | US-Japan military relationship is the Pacific deterrence cornerstone. Joint exercises, base hosting, intelligence sharing. Shield is your most important contact. |
...
### VANGUARD — President of Hanguk

| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** (Columbia) | TENSION | Treaty ally in constitutional crisis. Semiconductor power (Samsung). Columbia needs you for Pacific security but your political chaos limits cooperation. |
| **Pyro** (Choson) | HOSTILE | Nuclear threat from the north. Existential. |
| **Sakura** (Yamato) | TENSION | Shared threats but colonial scars. Trade wars. Forced cooperation despite deep mistrust. |

### HAVANA — Leadership of Caribe
...
| Who | Type | Dynamic |
|-----|:----:|---------|
| **Dealer** (Columbia) | ALLIANCE | F-35 buyer, investment hub. Columbia needs you as a Persian Gulf staging ground. |
| **Wellspring** (Solaria) | TENSION | Sibling rivalry. You compete for investment, tech hub status, Columbia favor. Cooperate on Persia threat but watch each other closely. |
| **Helmsman** (Cathay) | CHANNEL | Technology crossroads between Columbia and Cathay. Your investment fund courts both. Discreet channel for deals that can't happen directly. |
...
| Type | Count | Meaning |
|------|:-----:|---------|
| HOSTILE | ~15 | Active conflict or existential opposition |
| TENSION | ~20 | Friction, rivalry, competing interests |
| ALLIANCE | ~22 | Shared interests, warmth, partnership |
| DEPENDENCY | ~8 | Asymmetric reliance (one side needs the other more) |
| CHANNEL | ~12 | Back-channel, intermediary, communication bridge |
| INTERNAL | ~10 | Within-team structural dynamic |

**Total: ~87 relationships across 37 roles.**

---

## Key Design Notes

1. **Asymmetric by design.** Dealer's view of Helmsman ("I respect the deal-maker") differs from Helmsman's view of Dealer ("structures pull us apart"). This asymmetry creates negotiation space.
...
*This document feeds directly into role briefs. Slice by role name to extract each participant's relationship section.*
