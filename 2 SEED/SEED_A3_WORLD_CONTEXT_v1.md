# World Context Briefing
## The Thucydides Trap — Opening Narrative
**Version:** 1.0 | **Date:** 2026-03-29 | **Classification:** PUBLIC — all participants receive this

---

*Read time: 5 minutes. This is your world as of July 2026.*
...
**This is the Thucydides Trap:** a rising power and a ruling power, each fearing the other, each making rational decisions that collectively push toward catastrophe. History says this ends in war. Your job is to prove history wrong — or to win the war it predicts.
...
**Formosa.** Cathay claims the island. Its military exercises last December were the largest ever. The PLA is targeting 2027 readiness. Formosa produces 60% of the world's advanced semiconductors — the chips that run everything from phones to missiles. Every major economy depends on them. If Formosa falls, the global tech supply chain shatters. If Cathay's domestic chip production catches up (projected 2028-2030), Formosa's "silicon shield" stops being a deterrent and becomes an invitation.

Columbia's navy currently outguns Cathay's in the Pacific — 11 capital ships to 7. But Cathay adds one per year. The crossover comes in 2028. After that, defending Formosa becomes exponentially harder.

**Thule.** Columbia has claimed this Arctic territory — currently governed by a European ally. The claim stunned Europe. If Columbia can threaten an ally's sovereignty, what is NATO worth?

**The Gulf Gate.** Persia's ground-based blockade cannot be broken from the air. Someone will need to send ground troops into the most fortified coastline in the region. Until then, every oil-importing country pays the price.
...
**The AI revolution.** Artificial intelligence is transforming military capability, economic productivity, and surveillance capacity simultaneously. Columbia and Cathay are in a race for AI supremacy. Whoever gets there first gains advantages that may be irreversible. Tech transfer, export controls, and espionage are the invisible front of this competition.

---

## The World You Enter

Twenty countries and three contested territories. Six rounds minimum, eight maximum — each representing six months. Two active wars. One blockade. One island everyone depends on and two powers are willing to fight over. An election that will reshape the world's most powerful country. A peace plan no one has agreed to. A nuclear threshold creeping closer. An alliance system fracturing under the weight of a leader who despises his own allies.

And in the middle: countries that refuse to pick a side — Bharata, Solaria, Phrygia — playing all sides, extracting maximum leverage, knowing that the moment they're forced to choose, they lose everything that makes them valuable.

Your decisions will determine whether the Trap springs shut or whether extraordinary leadership forces a different outcome. History is not on your side. But history is what happened when the people in the room weren't good enough.

This time, you're in the room.

---

*Detailed role briefs, country data, and starting positions are provided separately. This briefing establishes the shared context — what everyone knows when the simulation begins.*
