...
│   ├── #9 Naval bombardment (10% per ship, safe, slow)
│   ├── #10 Air strike (AD interception, 15% hit per survivor)
│   ├── #11 Strategic missile / nuclear (5-tier, 10-min authorization clock)
