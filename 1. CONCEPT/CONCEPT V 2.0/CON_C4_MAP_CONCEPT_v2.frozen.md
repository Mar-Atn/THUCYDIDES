...
- Military force deployment markers — where each country's units are currently positioned, by type (ground, naval, tactical air/missiles, strategic missiles, air defense). Air defense deployment is a visible strategic signal — protecting a zone is a commitment.
...
Ground forces dominate. Territory changes matter for stability, negotiating leverage, and national morale. The proven dice-combat mechanic from the Conflict SIM applies here.
...
- **Military:** Unit deployment markers (5 types: ground, naval, tactical air, strategic missiles, air defense), theater combat zones, force projection ranges, blockade indicators, strategic missile launch alerts (global visibility)
- **Economy:** Trade routes, energy flows, sanctions impact (could show as dimmed trade lines), chokepoint control, oil price indicator
- **Internal politics:** Territorial losses/gains affect stability, refugee flows have direction and destination
- **Technology:** Semiconductor facilities marked (Formosa), nuclear sites marked (Persia, Choson), missile ranges as overlays, R&D progress indicators for countries near breakthroughs
...
- **v1.1 (2026-03-21):** Aligned with E1 Engine Architecture v0.7. Global map shows 5 unit types including air defense deployment. Strategic missile launch alerts visible globally on map. Domain relationships updated for 5 unit types and strategic missiles. Open questions resolved: theater activation on first attack, 5 pre-set theaters, naval mechanics per E1 combat model.
