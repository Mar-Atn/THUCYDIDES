        ...
        "properties": {
            "action": {
                ...
                "description": (
                    ...
                    "\n"
                    "ECONOMIC:\n"
                    "  set_budget: social_pct (0.5-1.5), production {branch: 0-4}, research {nuclear_coins, ai_coins}\n"
                    "  set_tariffs: target_country, level (0-3)\n"
                    "  set_sanctions: target_country, level (-3 to +3)\n"
                    "  set_opec: production (min|low|normal|high|max) — OPEC members only\n"
                    "\n"
                    "COMMUNICATION:\n"
