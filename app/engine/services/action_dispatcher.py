...
def _respond_to_meeting(sim_run_id: str, action: dict) -> dict:
    ...
    # Enqueue meeting_started events for AI participants
    # Intent notes are generated by Managed Agents (SPEC 4.2) — stored in meeting
    # metadata via tool_executor when agents invite/accept.
    if meeting_id:
        inviter_role_id = inv.get("inviter_role_id", "")
