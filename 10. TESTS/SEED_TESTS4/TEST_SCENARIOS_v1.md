# SEED Stage Test Scenarios — Battery 4
## Thucydides Trap SIM — Pre-Gate Validation
**Version:** 1.0 | **Date:** 2026-03-30 | **Engine:** v2.8+ (post action review)

---

## 8 Scenarios

### S1: BASELINE — "Let the world run"
No tweaks. All 21 countries, standard data, 8 rounds. Control test.
**Focus:** Credible narrative? Structural clocks work? Oil price? Feedback loops?

### S2: MILITARY BALANCE — "Cathay goes for Formosa at R4"
...
**Focus:** 5-tier nuclear system, R&D acceleration, detection tiers, deterrence logic, 10-min clock.

### S5: ECONOMIC WARFARE — "Oil shock + tariff war"
OPEC MIN production + Columbia-Cathay tariff war simultaneously.
**Focus:** 5-level oil formula, per-sector tariffs, demand destruction, inflation cascade, BRICS+ currency.

### S6: POLITICAL CRISIS — "Columbia implodes"
Dealer arrests Tribune, fires Shield, emergency. Impeachment follows.
...
*Run by independent Tester instance per TESTER_CONCEPT.md protocol.*
