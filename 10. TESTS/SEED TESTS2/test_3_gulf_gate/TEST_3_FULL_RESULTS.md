...
- OPEC: Nordostan starts HIGH (flooding market). Will coordination hold?
...
- Nordostan: HIGH (needs revenue for war, broke sanctions solidarity)
...
| **Nordostan** | OPEC: HIGH (+0.06 supply). Sells discounted oil to Cathay (15% off). Needs cash for war. |
...
| **Columbia** | Gulf Gate assault: 1 naval + 1 ground. Budget: 4 coins to military, 3 coins to Heartland aid. |
| **Cathay** | Buys Nordostan energy at 15% discount. 3 coins to Ponte BRI. +1 naval produced. |
| **Teutonia** | Emergency energy procurement. 2 coins to strategic reserve. |
| **Bharata** | Buys discounted Nordostan oil through intermediaries. Sanctions evasion. |
...
WAR PREMIUM:
  ...
  War 2: Nordostan vs Heartland (major) → +0.10
...
| **Nordostan** | 20 | 40% | 20 × 0.40 × (221/80-1) × 0.3 = **4.22** | War chest refilling despite sanctions. |
...
| Nordostan | 1.0% | sanctions(0.85) × war(0.92) × inflation(0.96) | **0.75%** | 20 × 1.0075 = **20.15** |
...
| Nordostan | 20.15 | WINDFALL (+4.22 oil rev) | 4.90 | 54% | ~4 | Oil revenue keeping war funded |
| Heartland | 2.25 | No oil, receiving aid | 4.62 | 50% | ~2 | Losing territory, dependent on aid |
...
### Context
Columbia midterm elections this round. Gulf Gate still blocked. Oil at $221 is creating domestic pressure. Nordostan's HIGH production provides some relief but also funds their war. OPEC is under pressure from importers to increase supply.
...
| **Nordostan** | OPEC: HIGH (continues). Expanding Cathay pipeline. |
...
| **Columbia** | NO second Gulf Gate assault (midterms — cannot afford another failure). Increases aid to Heartland (+4 coins). Dealer focuses on elections. |
...
| **Bharata** | BRICS+ summit agenda: proposes "energy stability framework." Buys more Nordostan oil. |
...
| **Nordostan** | 20.3 | 40% | 20.3 × 0.40 × (194/80-1) × 0.3 = **3.47** | -0.75 (still massive for wartime) |
...
| Nordostan | 20.15 | 0.70% | **20.3** | Barely growing but oil revenue sustains |
...
| Nordostan | 20.3 | 4.82 | 53% | ~5 | Oil keeps war going |
...
### Context
Columbia at 32% support. Blockade in 3rd round. Oil at $194. Domestic pressure forces action. Heartland wartime election approaching (R3-4). Nordostan's oil revenue is funding the war — this becomes visible intelligence. Columbia must decide: break the blockade (costly) or negotiate (politically devastating)?
...
| **Nordostan** | OPEC: HIGH. Expands pipeline capacity to Cathay. Signs arms-for-oil deal with Bharata. |
...
SUPPLY:
  OPEC: Solaria HIGH (+0.06), Nordostan HIGH (+0.06), Mirage HIGH (+0.06), Persia NORMAL
  supply_factor = 1.18
...
| Nordostan | 20.4 | 3.19 | **10.88** |
| Mirage | 5.7 | 0.65 | **2.15** |
| Persia | 4.71 | 0.78 | **2.48** (mostly inaccessible) |

**Nordostan cumulative oil revenue through 3 rounds: 10.88 coins.** This is funding approximately 7 ground units worth of war production. The blockade is inadvertently subsidizing Nordostan's war against Heartland.
...
| Nordostan | 20.4 | 4.75 | 52% | ~6 | Oil-funded war machine |
...
### Context
Columbia at 31% support. Presidential election in R5. Must show progress. Heartland wartime election this round. Persia stability at 3.60 — one more shock could trigger internal crisis. Columbia launches the big Gulf Gate operation.

### Decisions

| Country | Key Economic Decisions |
|---------|----------------------|
| **Solaria** | OPEC: Returns to NORMAL. Revenue per barrel dropping too fast. Signals to Nordostan to coordinate. |
| **Nordostan** | OPEC: Returns to NORMAL. Agrees with Solaria — price is falling too fast despite blockade. |
...
| Nordostan | 20.5 | 20.5 × 0.40 × (250/80-1) × 0.3 = **5.22** | PEAK — funds massive war production |
| Mirage | 5.9 | 5.9 × 0.30 × (250/80-1) × 0.3 = **1.13** | Peak |

**Cumulative Nordostan oil revenue R1-R4: 16.10 coins.** Enough to produce 10+ ground units at wartime rates.

### Heartland Wartime Election

Heartland at stability 4.40, support 46%. Territory lost. Casualties mounting. But democratic resilience (+0.15/round) and Columbia aid keeping it viable.
...
| Nordostan | 20.5 | 4.68 | 51% | ~8 | Peak oil revenue funding war |
...
| **Nordostan** | OPEC: NORMAL. No longer needs to flood — prices are dropping anyway. |
...
SUPPLY:
  OPEC: Solaria HIGH (+0.06), Nordostan NORMAL, Mirage HIGH (+0.06), Persia NORMAL
...
- But: 8 rounds of economic pain, naval losses, ally Heartland losing territory
...
| Nordostan | 20.6 | 2.90 | -2.32 (-44%) |
| Mirage | 6.0 | 0.63 | -0.50 (-44%) |

Revenue drops proportionally with price. The $76 drop hits ALL producers equally. Nordostan loses 2.32 coins/round — equivalent to 1.5 ground units of production capacity per round.
...
| Nordostan | 20.6 | 4.60 | 50% | ~6 | Revenue dropping, war costly |
...
| **Nordostan** | OPEC: NORMAL. Same logic. |
...
WAR PREMIUM:
  ...
  Nordostan-Heartland: continuing → +0.10
  war_premium = 0.10
...
| Nordostan | 20.7 | 4.55 | 49% | ~5 | Revenue declining |
...
### Context
Gulf Gate fully cleared. Persia ceasefire signed. Only Nordostan-Heartland war continues. Oil markets normalizing. Formosa Strait tension remains.
...
| **Nordostan** | OPEC: LOW (-0.06). Joins Solaria in price support. War needs funding. |
...
SUPPLY:
  OPEC: Solaria LOW (-0.06), Nordostan LOW (-0.06), Mirage NORMAL, Persia NORMAL
  supply_factor = 1.0 - 0.12 = 0.88
  Sanctions supply hit: 0.16 (Nordostan + Persia still sanctioned)
...
| Nordostan | 20.8 | 4.50 | 48% | ~5 | OPEC LOW props revenue |
...
| **Nordostan** | OPEC: NORMAL. War grinding down, ceasefire talks beginning. |
| **Mirage** | OPEC: NORMAL. |
...
WAR PREMIUM:
  Nordostan-Heartland (ceasefire talks) → +0.05 (reduced)
  war_premium = 0.05
...
| Nordostan | 20.9 | 4.45 | 47% | ~5 | 2 | War winding down |
| Heartland | 2.5 | 3.80 | 42% | ~1 | 0 | Survived but battered |
...
| Nordostan | 4.22 | 3.47 | 3.19 | 5.22 | 2.90 | 2.25 | 2.30 | 1.58 | **25.13** |
| Mirage | 0.79 | 0.71 | 0.65 | 1.13 | 0.63 | 0.50 | 0.48 | 0.38 | **5.27** |
| Persia | 0.92 | 0.80 | 0.78 | 1.10 | 0.60 | 0.40 | 0.35 | 0.30 | **5.25** |

**Nordostan total: 25.13 coins from oil alone over 8 rounds.** At 1.5 coins/ground unit (wartime production), that funds 16+ ground units. The blockade that was meant to pressure Persia enriched Nordostan — Columbia's other adversary.
...
**CRITICAL DESIGN FINDING.** The Gulf Gate blockade is meant to be Persia's weapon against Columbia and Gulf states. But the primary economic beneficiary is **Nordostan** — Columbia's other enemy. Nordostan earns 25+ coins from elevated oil prices over 8 rounds, directly funding its war against Heartland (Columbia's ally).

This is either:
- (a) A brilliant emergent dynamic that creates a genuine strategic dilemma for Columbia (breaking the blockade helps Heartland indirectly by reducing Nordostan's revenue), or
...
Even after the blockade clears, sanctions on Nordostan and Persia maintain a permanent 0.16 supply hit. This keeps oil above $100 in all post-crisis scenarios. Lifting sanctions on either country would drop supply_hit to 0.08, reducing prices by ~$15-20.

**This creates a sanctions trade-off:** maintaining sanctions on Nordostan hurts Columbia's own economy through elevated oil prices. This is a genuine design tension that forces choices.
...
| 5 | Nordostan enriched by 25+ coins from Persia's blockade | FEATURE | Intentional emergent dynamic — document as design feature |
