...
**Objective:** Test the ceasefire mechanic. Can Nordostan and Heartland reach a deal? What terms emerge? Does the ceasefire transaction work?

**Setup Overrides (deviations from Test 1 baseline):**
- Nordostan: Compass back-channel VERY ACTIVE (increased deal-seeking). Pathfinder more open to framework.
- Columbia: Dealer pushing HARD for Heartland deal (personal legacy obsession).
...
| Territory | ~40% Heartland occupied (4 oblasts claimed, ~65-70% controlled) | Defending remaining 60% |

### Negotiation Track

**Dealer --> Pathfinder (via Riyadh back-channel):**
"I want a deal. Heartland is Europe's problem. I need something for television — a ceremony, a handshake, Pathfinder and Dealer on the White House lawn. Your troops stay where they are. We call it a 'security arrangement.' Sanctions unwind over 18 months. NATO stays out of Heartland. What do you say?"

**Pathfinder --> Dealer (via same channel):**
"I respect a man who makes deals. I am ready. But I need REAL recognition — not an arrangement, sovereignty over the annexed territories. And NATO membership for Heartland is the red line. Kill the membership process or there is no deal."
...
"Heartland is prepared to discuss security architecture for durable peace. Floor: EU membership, Western security forces on soil, no sovereignty concessions."

**Dealer response to Beacon:** Delayed 48 hours. Then: "I hear you. We're looking at all the options."

### Analysis R1
- **Gap identified:** Pathfinder demands sovereignty recognition over all four oblasts + no NATO for Heartland. Beacon demands no territorial concessions + EU membership + Western troops. These positions are maximalist on both sides.
- **Dealer's position:** Indifferent to Heartland's demands. Wants the photo op. Will sacrifice Heartland's interests for his legacy deal.
...
- **Heartland not at the table.** Dealer is negotiating FOR Heartland WITHOUT Heartland. Beacon is demanding to be included but has zero leverage to force it.

### Military Actions
- Nordostan: Donetsk concentration continues. Gains heartland_15. Grinds forward.
- Heartland: Defensive hold. Drone strikes on logistics (4 rail corridors).
...
FURIOUS. Direct call to Dealer: "You are negotiating away my country without my consent. No framework has legitimacy without Heartland's signature. I will go public."
...
- **Sentinel (Freeland):** OPPOSED. "Any deal that rewards Nordostan's aggression guarantees they invade again in 10 years. We will be the next target."
- **Lumiere (Gallia):** "France must be at the table. No deal without European security guarantee architecture."
- **Mariner (Albion):** Shares Dealer-Pathfinder back-channel details with Beacon. Opposes any deal without Heartland consent but works the process.
- **Ponte:** "If sanctions are lifted and energy prices drop, I support whatever framework achieves that."

### Military Actions
- Nordostan: Continued Donetsk grinding. Gains partial control of heartland_16. But Zaporizhzhia front thinned — Heartland drone strikes disrupting 2 of 4 rail corridors. Supply strain.
- Heartland: Receives 1 AD unit from Columbia. Drone campaign intensified.
...
| Nordostan | 20.3 | 4.80 | 53% | ~0 (Cathay credit) | Treasury empty, Donetsk gains |
| Heartland | 2.30 | 4.45 | 48% | ~2 | Stability falling, election pressure |
| Oil Price | $189 | — | — | — | Declining on partial Gulf Gate + expectations |

---

## ROUND 3 (H1 2027) — HEARTLAND ELECTION + FRAMEWORK EMERGES

### Key Events
- **Heartland wartime election** (first round) this round.
- Nordostan approaching 3 years of war. Economy sustained only by Cathay.
...
>    - Existing administrations remain in place (de facto Nordostan governance).
...
> 3. Heartland commits to non-alignment for 25 years — no NATO membership application.
> 4. Sanctions phase-out: 30% immediate upon ceasefire, 70% over 36 months tied to compliance.
> 5. EU membership for Heartland: not addressed (explicitly excluded from framework scope).
> 6. Security guarantees: G7 "enhanced partnership" with Heartland (deliberately vague — NOT Article 5).
> 7. POW exchange within 30 days.
> 8. Dealer-Pathfinder-Beacon trilateral summit for signing.

**Pathfinder's response:**
"Points 1-2: Acceptable with modifications. 'Special Security Zones' must include referendum provision — the people choose. We know how they will choose. Point 3: 25 years insufficient. 40 years. Point 4: Acceptable. Point 5: EU membership IS a security matter. Must be explicitly prohibited or framework is meaningless — EU mutual defense clause replicates NATO Article 5. Point 6: No foreign security guarantees on Heartland soil. G7 partnership is propaganda. Point 7: Acceptable. Point 8: Acceptable — I want the summit."

**Beacon's response:**
"REJECTED. (1) No ceasefire that freezes occupation. My territory is not a 'zone.' (2) No NATO renunciation. (3) The 'comprehensive settlement in 10 years' is a fiction — Nordostan will never negotiate return. (4) 'Enhanced partnership' is worth less than the paper it is written on. Budapest Memorandum was worth nothing. (5) I need TROOPS, not WORDS. European security forces on my soil. (6) If EU is excluded from scope, Heartland rejects the entire framework."

**Broker (shadow diplomacy, separate from Beacon):**
Contact to Forge and Pillar: "Beacon will reject anything. I would not. If I win the election, I bring a framework Europe can support: ceasefire at current lines, EU fast-track, European security force, face-saving language for Nordostan. My price: EU membership by 2029."

**Compass --> Geneva channel:**
"The referendum language is Pathfinder's minimum. He needs to show his people they 'chose' Nordostan. Give us the word 'referendum.' We both know it means nothing with Nordostan troops present. But it gives him the domestic narrative."

### Heartland Wartime Election (Round 3 — First Round)

**AI Score (Heartland):**
- GDP growth 2.36%, stability 4.45, 1 active war (Nordostan)
...
### Military Actions R3
- Nordostan: Donetsk advance slows. Supply disruption from drone strikes. Net gain: partial heartland_17. Zaporizhzhia front static.
- Heartland: Defensive hold. Receives additional Storm Shadow from Albion. Uses 2 on Nordostan logistics hubs (rail junction at Belgorod equivalent).
- Nordostan casualties: -2 ground (11 -> 9 front). Heartland: -1 ground (5 -> 4 front).

### Engine Results R3
| Country | GDP | Stability | Support | Treasury | Key |
|---------|-----|-----------|---------|----------|-----|
| Nordostan | 20.4 | 4.65 | 51% | ~0 | Grinding, broke, support eroding |
| Heartland | 2.35 | 4.20 | 43% | ~2 | Election lost R1, authority crumbling |
| Oil Price | $175 | — | — | — | Declining on partial Gulf Gate + Persia talks |

---

## ROUND 4 (H2 2027) — HEARTLAND RUNOFF + CRISIS POINT

### Key Events
- **Heartland wartime election RUNOFF** this round.
- Dealer escalates pressure on Beacon: "Sign the framework or I cut all aid."
- Nordostan approaching fiscal collapse — 4 rounds of deficit.
...
**Beacon REJECTS the framework again.** Public statement: "Heartland will not accept a peace dictated by others. Our people did not fight and die for 'special security zones.' We fight for our land, our sovereignty, our future in Europe."

**Pathfinder (to Compass):**
"Beacon is finished. Wait for the new one. The election changes nothing for us — whoever wins Heartland needs peace more than we do. Our position improves with time."

**Compass:** "No, it does not. Treasury is zero. Cathay credit is not infinite. Helmsman is already signaling: 'resolve this or we recalibrate.' He does not want to bankroll a frozen conflict. The new Heartland leader — whoever it is — will be more flexible. Push Dealer for the summit NOW, before his own election cycle paralyzes him."

### Heartland Wartime Runoff (Round 4)

**AI Score (Heartland, R4):**
...
**Final:** 0.5 * 43.0 + 0.5 * 35 = 39.0%. **Beacon loses.** Bulwark becomes president of Heartland.
...
- **Lumiere:** Immediately proposes Franco-British-Heartland security triangle.
...
### Military Actions R4
- Nordostan: Offensive tempo reduced. Cannot sustain momentum with zero treasury. Supply issues from drone strikes. Net: no territorial gain this round.
- Heartland: Bulwark orders selective counterattack — 2 ground units probe Zaporizhzhia front. Nordostan, weakened, loses 1 ground. **First Heartland territorial recovery** — partial recapture of heartland_14.
- Casualties: Nordostan -1 ground (9 -> 8 front). Heartland -0 (probing attack succeeded).

### Engine Results R4
| Country | GDP | Stability | Support | Treasury | Key |
|---------|-----|-----------|---------|----------|-----|
| Nordostan | 20.2 | 4.50 | 49% | ~0 | Stalled, support falling, Zaporizhzhia loss |
| Heartland | 2.40 | 4.35 | 55% (Bulwark) | ~2 | New president rally, morale boost |
...
- Nordostan's Zaporizhzhia setback + fiscal collapse creates urgency.
...
(3) NATO: I accept a moratorium on membership APPLICATION — 15 years. But Heartland retains the right to ASPIRE. And the moratorium does not apply to EU membership.
...
"The new Heartland president is more realistic. But:
...
(e) NO European security force. Foreign troops on Nordostan's claimed territory is unacceptable.
...
**Volt's pivot:** "I will complete the peace framework. But my priority is Cathay competition, not European security architecture. Europe must lead on the Heartland file. I give you 90 days to close the deal or I move on."
...
### Military Actions R5
- Nordostan: Minimal offensive activity. Treasury empty. Consolidation of held territory.
- Heartland (Bulwark): Continues selective probes on Zaporizhzhia front. Nordostan's thinned lines give way at heartland_18. **Second territorial recovery.**
- Net position: Nordostan now holds ~38% (down from ~42% peak).

### Engine Results R5
| Country | GDP | Stability | Support | Treasury | Key |
|---------|-----|-----------|---------|----------|-----|
| Columbia | 295.5 | 6.85 | 48% (Volt) | ~42 | New president, Persia ceasefire |
| Nordostan | 20.0 | 4.35 | 47% | ~0 | Losing ground, broke, support collapsing |
| Heartland | 2.50 | 4.50 | 58% (Bulwark) | ~3 | Territory recovered, morale up |
...
- Nordostan's fiscal crisis now existential — 5 rounds of deficit.
- Heartland gaining ground. Momentum shift.
...
Participants: Volt (Columbia), Pathfinder (Nordostan), Bulwark (Heartland), Lumiere (Gallia), Forge (Teutonia), Mariner (Albion).

**Pathfinder arrives with revised position (Compass's fingerprints):**
1. Ceasefire at current lines (accepts Heartland recovery of heartland_14 and heartland_18).
...
4. NATO moratorium: 20 years on membership application. Heartland retains aspiration language.
...
**Bulwark's response:**
"Close. But:
(a) 'Consultative mechanisms' is referendum by another name under occupation. The process must include displaced persons voting. 5 million Heartlanders cannot be excluded from deciding their own territory's fate.
...
"A separate document. The peace framework stands alone — signed by Nordostan, Heartland, Columbia. On the same day, in a separate ceremony, the EU issues a declaration on Heartland candidacy. Pathfinder does not sign the EU document. The EU does not sign the peace framework. Both happen. Both are real. Neither is formally linked."
...
- War tiredness: Nordostan 3.5, Heartland 3.0.

### Engine Results R6
| Country | GDP | Stability | Support | Treasury | Key |
|---------|-----|-----------|---------|----------|-----|
| Nordostan | 19.8 | 4.25 | 45% | ~0 | Approaching political danger zone |
| Heartland | 2.55 | 4.60 | 60% (Bulwark) | ~3 | Bulwark momentum |
...
### Key Events
- Nordostan support at 45% — approaching instability threshold (40%).
...
>
> Signed by: Nordostan (Pathfinder), Heartland (Bulwark), Columbia (Volt)
...
>
> **Article 2: Interim Administrative Arrangements.** Territories currently under Nordostan administration shall maintain existing governance structures under international civilian monitoring. 3,000 EU-mandated civilian monitors deployed within 60 days. Monitor mandate: ceasefire verification and humanitarian reporting to OSCE.
>
...
>
> **Article 4: Security Architecture.** Heartland commits to a 20-year moratorium on NATO membership application, commencing from date of signing. Both parties commit to confidence-building measures and military transparency.
>
...
>
> **Article 8: Dispute Resolution.** Ceasefire violations reported to Joint Monitoring Commission (3 Nordostan + 3 Heartland + 3 international). Verified breach triggers automatic review at UNSC.

**Parallel EU Declaration (same day, separate ceremony):**

> The European Council confirms Heartland's candidate status and commits to opening all remaining accession negotiation clusters within 12 months. The path to full EU membership proceeds on its own merits and timeline.
...
Sender: nordostan
Receiver: heartland
Signatories: [nordostan, heartland]
...
3. War lookup: `ws.wars` scanned for nordostan-heartland conflict.
4. War found: attacker=nordostan, defender=heartland, allies={attacker: [choson]}.
5. Signatories [nordostan, heartland] — nordostan on attacker side, heartland on defender side. **Match found.**
6. War REMOVED from `ws.wars`.
7. Event logged: `{type: "ceasefire", agreement_id: "agreement_X", ended_war: {...}, signatories: [nordostan, heartland]}`
8. `wars_ended: 1` in execution_details.

**Verification:** `len(ws.wars)` reduced by 1. Eastern Ereb Theater war no longer active. Combat resolution engine will skip Nordostan-Heartland pairs in future rounds.

### Reactions

**Pathfinder (public):** "Nordostan has secured peace with honor. The territories are under our administration. The West has acknowledged reality. NATO expansion is halted for a generation. This is victory."

**Bulwark (public):** "The killing stops today. Heartland's path to Europe is confirmed. Our sovereignty is not conceded — it is defended through law, through institutions, through the presence of international monitors. This is the beginning, not the end."
...
| Country | GDP | Stability | Support | Treasury | Key |
|---------|-----|-----------|---------|----------|-----|
| Nordostan | 20.5 | 5.10 (+0.85) | 52% (+7) | ~1 (sanctions starting) | **Peace dividend: stability + support spike** |
| Heartland | 2.65 | 5.30 (+0.70) | 63% (Bulwark) | ~3 | **Peace dividend: stability + support spike** |
| Oil Price | $108 | — | — | — | War premium gone, Gulf Gate opening |

**Stability bounce:**
- Nordostan: War friction removed (+0.15), sanctions relief expectation (+0.20), peace announcement (+0.50). Total: +0.85.
- Heartland: War friction removed (+0.20), EU candidacy confirmed (+0.15), peace hope (+0.35). Total: +0.70.
...
**Nordostan compliance:** DMZ observed. Troop pullback from 7.5km zone. BUT: Nordostan security forces (not military) remain in occupied zones. Monitoring mission reports "governance activities inconsistent with interim administration" — construction of permanent infrastructure, population registration, currency introduction.

**Heartland response:** Files complaint with Joint Monitoring Commission. "Nordostan is consolidating permanent control under the guise of interim administration."

**Nordostan response:** "Interim administration requires functioning governance. Schools, hospitals, currency — these serve the population. This is not a violation."
...
- Nordostan sanctions reduced from L3 to L2 (partial).
...
**Nordostan:** Begins slow drawdown. 2 ground units rotated out of Heartland (8 -> 6 on front equivalent, now behind DMZ). Maintenance costs drop. Treasury begins recovering.

**Heartland:** Bulwark maintains defensive posture. Does NOT demobilize. Redirects 1 ground to rear training (quality over quantity). Receives EU-funded equipment modernization.
...
| Country | GDP | Stability | Support | Treasury | Key |
|---------|-----|-----------|---------|----------|-----|
| Nordostan | 21.5 | 5.30 | 54% | ~3 | Recovering. Sanctions relief flowing. |
| Heartland | 2.80 | 5.55 | 61% | ~4 | Strongest position since war began |
...
6. **DESIGN HOLE: Sanctions relief schedule is not automated.** The agreement specifies 30-60-36 phased relief but this must be manually applied each round. No automated schedule exists.
   ...
   **Recommendation:** Add a `scheduled_effects` list to the agreement data structure:
   ```python
   "scheduled_effects": [
       {"round_offset": 1, "effect": "sanctions_reduce", "target": "nordostan", "from": "L3", "to": "L2"},
       {"round_offset": 6, "effect": "sanctions_reduce", "target": "nordostan", "from": "L2", "to": "L1"},
       ...
   ]
   ```
   The world model engine checks active agreements each round and applies scheduled effects.

7. **DESIGN HOLE: Choson's status in the ceasefire is undefined.** Choson has 2-4 ground units fighting alongside Nordostan but is not a signatory. The ceasefire mechanic checks `allies.attacker` list and finds Choson — but the code only checks if SIGNATORIES are on opposing sides. Choson continues to be at war with Heartland unless separately addressed.
...
10. **Dealer's personal involvement both helped and complicated.** Helped: forced pace, provided great-power pressure, created diplomatic infrastructure. Complicated: bypassed Heartland, created legitimacy crisis, prioritized photo op over substance. This dual effect is precisely what the role design intended.
...
| 2 | 20.3 | 4.80 | 53% | 0 | ~41% |
| 3 | 20.4 | 4.65 | 51% | 0 | ~42% |
| 4 | 20.2 | 4.50 | 49% | 0 | ~40% (lost heartland_14) |
| 5 | 20.0 | 4.35 | 47% | 0 | ~38% (lost heartland_18) |
| 6 | 19.8 | 4.25 | 45% | 0 | ~38% |
...
3. Run Test 5 with HOSTILE Nordostan (no setup override) to verify that the war can also NOT end — confirming the ceasefire is earned, not inevitable.
4. Run breach scenario: what happens when Nordostan violates the DMZ in R8+? Does the snap-back work?
